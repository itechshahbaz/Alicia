...
function alCargar(){
	...
	if (idioma==2) {
		document.getElementsByTagName("header")[0].innerHTML="<p id='ptwitter' style='font-family:kurzetstypekurzetstype;font-Size:0.3em;'><a id='atwitter' href='#' target='_blank'></a></p>";
		...
		document.getElementsByTagName("header")[0].innerHTML="<p id='ptwitter' style='font-family:kurzetstypekurzetstype;font-Size:0.3em;'><a id='atwitter' href='https://twitter.com/JosePolLezcano' target='_blank'></a></p>";
